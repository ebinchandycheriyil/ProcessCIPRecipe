...
'LYTA_18' : tagDetails('Caustic Cycle Time for Caustic Circulation', 'Time', 'T_18', 'Program:CktA.CausticCirTimerPara.CircCycleTime'),
...
'LYTB_18' : tagDetails('Caustic Cycle Time for Caustic Circulation', 'Time', 'T_18', 'Program:CktB.CausticCirTimerPara.CircCycleTime'),
...
'ACSA_21' : tagDetails('Tank Temp for Acid Circulation', 'INT', 'SP_21', 'Program:CktA.AcidCirProcessPara.TankTempSetValue'),
'ACSA_22' : tagDetails('Flow Rate for Acid Circulation', 'INT', 'SP_22', 'Program:CktA.AcidCirProcessPara.FlowSetValue'),
'ACSA_23' : tagDetails('Return Temp for Acid Circulation', 'INT', 'SP_23', 'Program:CktA.AcidCirProcessPara.ReturnTempSetValue'),
'ACSA_24' : tagDetails('Dosing SetValue for Acid Circulation', 'INT', 'SP_24', 'Program:CktA.AcidCirProcessPara.DosingSetValue'),
'ACSA_25' : tagDetails('Return Conductivity 1 for Acid Circulation', 'INT', 'SP_25', 'Program:CktA.AcidCirProcessPara.ReturnConductSetValue1'),
'ACSA_26' : tagDetails('Return Conductivity 2 for Acid Circulation', 'INT', 'SP_26', 'Program:CktA.AcidCirProcessPara.ReturnConductSetValue2'),
'ACSA_27' : tagDetails('Dosing RetSetValue for Acid Circulation', 'INT', 'SP_27', 'Program:CktA.AcidCirProcessPara.DosingResetValue'),
'ACSA_28' : tagDetails('Hold SetValue for Acid Circulation', 'INT', 'SP_28', 'Program:CktA.AcidCirProcessPara.HoldSetValue'),
...
'ACTA_18' : tagDetails('Caustic Cycle Time for Caustic Circulation', 'Time', 'T_18', 'Program:CktA.CausticCirTimerPara.CircCycleTime'),
...
'ACTA_25' : tagDetails('Return Pump On Time for Acid Circulation', 'Time', 'T_25', 'Program:CktA.AcidCirTimerPara.ReturnPumpOnTime'),
'ACTA_26' : tagDetails('Supply Pump On Time for Acid Circulation', 'Time', 'T_26', 'Program:CktA.AcidCirTimerPara.SupplyPumpOnTime'),
'ACTA_27' : tagDetails('Intermediate stop time for Acid Circulation', 'Time', 'T_27', 'Program:CktA.AcidCirTimerPara.InterMediateStopTime'),
'ACTA_28' : tagDetails('Pushing Time for Acid Circulation', 'Time', 'T_28', 'Program:CktA.AcidCirTimerPara.PushingTime'),
'ACTA_29' : tagDetails('Return Pump Off Time for Acid Circulation', 'Time', 'T_29', 'Program:CktA.AcidCirTimerPara.RPumpOffTime'),
'ACTA_30' : tagDetails('Drain Time for Acid Circulation', 'Time', 'T_30', 'Program:CktA.AcidCirTimerPara.DrainTime'),
'ACTA_31' : tagDetails('Acid Cycle Time for Acid Circulation', 'Time', 'T_31', 'Program:CktA.AcidCirTimerPara.CircCycleTime'),
...
'ACTA_36' : tagDetails('Return Pump On TimeFlow forAcid Circulation', 'Time', 'T_36', 'Program:CktA.AcidCirTimerPara.ReturnPumpOnTimeFlow'),
...
'ACSB_21' : tagDetails('Tank Temp for Acid Circulation', 'INT', 'SP_21', 'Program:CktB.AcidCirProcessPara.TankTempSetValue'),
'ACSB_22' : tagDetails('Flow Rate for Acid Circulation', 'INT', 'SP_22', 'Program:CktB.AcidCirProcessPara.FlowSetValue'),
'ACSB_23' : tagDetails('Return Temp for Acid Circulation', 'INT', 'SP_23', 'Program:CktB.AcidCirProcessPara.ReturnTempSetValue'),
'ACSB_24' : tagDetails('Dosing SetValue for Acid Circulation', 'INT', 'SP_24', 'Program:CktB.AcidCirProcessPara.DosingSetValue'),
'ACSB_25' : tagDetails('Return Conductivity 1 for Acid Circulation', 'INT', 'SP_25', 'Program:CktB.AcidCirProcessPara.ReturnConductSetValue1'),
'ACSB_26' : tagDetails('Return Conductivity 2 for Acid Circulation', 'INT', 'SP_26', 'Program:CktB.AcidCirProcessPara.ReturnConductSetValue2'),
'ACSB_27' : tagDetails('Dosing RetSetValue for Acid Circulation', 'INT', 'SP_27', 'Program:CktB.AcidCirProcessPara.DosingResetValue'),
'ACSB_28' : tagDetails('Hold SetValue for Acid Circulation', 'INT', 'SP_28', 'Program:CktB.AcidCirProcessPara.HoldSetValue'),
...
'ACTB_18' : tagDetails('Caustic Cycle Time for Caustic Circulation', 'Time', 'T_18', 'Program:CktB.CausticCirTimerPara.CircCycleTime'),
...
'ACTB_25' : tagDetails('Return Pump On Time for Acid Circulation', 'Time', 'T_25', 'Program:CktB.AcidCirTimerPara.ReturnPumpOnTime'),
'ACTB_26' : tagDetails('Supply Pump On Time for Acid Circulation', 'Time', 'T_26', 'Program:CktB.AcidCirTimerPara.SupplyPumpOnTime'),
'ACTB_27' : tagDetails('Intermediate stop time for Acid Circulation', 'Time', 'T_27', 'Program:CktB.AcidCirTimerPara.InterMediateStopTime'),
'ACTB_28' : tagDetails('Pushing Time for Acid Circulation', 'Time', 'T_28', 'Program:CktB.AcidCirTimerPara.PushingTime'),
'ACTB_29' : tagDetails('Return Pump Off Time for Acid Circulation', 'Time', 'T_29', 'Program:CktB.AcidCirTimerPara.RPumpOffTime'),
'ACTB_30' : tagDetails('Drain Time for Acid Circulation', 'Time', 'T_30', 'Program:CktB.AcidTankTimerPara.DrainTime'),
'ACTB_31' : tagDetails('Acid Cycle Time for Acid Circulation', 'Time', 'T_31', 'Program:CktB.AcidCirTimerPara.CircCycleTime'),
'ACTB_32' : tagDetails('Return Pump On TimeFlow for Hot Water Circulation', 'Time', 'T_32', 'Program:CktB.HWCirTimePara.ReturnPumpOnTimeFlow'),
'ACTB_33' : tagDetails('Return Pump On TimeFlow for Prerinse Circulation', 'Time', 'T_33', 'Program:CktB.PreRinseTimerPara.ReturnPumpOnTimeFlow'),
'ACTB_34' : tagDetails('Return Pump On TimeFlow for Castic Circulation', 'Time', 'T_34', 'Program:CktB.CausticCirTimerPara.ReturnPumpOnTimeFlow'),
'ACTB_35' : tagDetails('Return Pump On TimeFlow for Intermediate Circulation', 'Time', 'T_35', 'Program:CktB.IntermediateRinseTimerPara.ReturnPumpOnTimeFlow'),
'ACTB_36' : tagDetails('Return Pump On TimeFlow forAcid Circulation', 'Time', 'T_36', 'Program:CktB.AcidCirTimerPara.ReturnPumpOnTimeFlow'),
'HWTB_14' : tagDetails('Drain Time For PreRinse', 'Time', 'T_37', 'Program:CktB.PreRinseTimerPara.RPumpOffTime'),
'HWTA_14' : tagDetails('Drain Time For PreRinse', 'Time', 'T_37', 'Program:CktA.PreRinseTimerPara.RPumpOffTime'),
'LYTA_29' : tagDetails('Drain Time For PreRinse', 'Time', 'T_37', 'Program:CktA.PreRinseTimerPara.RPumpOffTime'),
'LYTB_29' : tagDetails('Drain Time For PreRinse', 'Time', 'T_37', 'Program:CktB.PreRinseTimerPara.RPumpOffTime'),
'ACTA_37' : tagDetails('Drain Time For PreRinse', 'Time', 'T_37', 'Program:CktA.PreRinseTimerPara.RPumpOffTime'),
'ACTB_37' : tagDetails('Drain Time For PreRinse', 'Time', 'T_37', 'Program:CktB.PreRinseTimerPara.RPumpOffTime'),
 }
